...
* Margin plots are done in much the same way as with linear regression
    * The biggest difference is the function use to predict
...
2. Use the `predict()` function with the `type="link"` option to use the model results to predict the log-odds fit of the "simulated" observations in the new data frame
