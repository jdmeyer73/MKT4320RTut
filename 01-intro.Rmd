...
#### Option 1: Use OSC Classroom OnDemand 
...
* **NOTE 2**: If using OSC Classroom OnDemand, all packages are already installed.
...
```{r echo=FALSE}
knitr::opts_knit$set(root.dir = "C:/Users/jdmeyer/Documents")
```
...
The `MKT4320BGSU` package is a package I created that contains data sets and user-defined functions for this course. By using this package when instructed, you will more easily be able to access the functions and data for the course, and you will have access to help files for the functions and data sets.

**NOTE**: If you using the OSC Classroom OnDemand for R/RStudio, this package is already installed.

If you are using your own machine, you will need to install this package.  The process for installing this package is a little different. You must first install the `devtools` package in order to use the `install_github` command.  The steps are shown in the code below.
