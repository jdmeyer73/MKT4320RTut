...
* The [yogurt.rdata](Data/yogurt.rdata) is used. Because of how the data is arranged, this data file contains two dataframes. One dataframe is a training sample, called `train.yog`, and the other dataframe is a test/holdout sample, called `test.yog`.  Both of these dataframes are included in the `MKT4320BGSU` package.
    ```{r}
    data(train.yog)
    data(test.yog)
    ```
